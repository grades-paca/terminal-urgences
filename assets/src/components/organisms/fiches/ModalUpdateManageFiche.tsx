...
import {type ApiPlatformError, isApiPlatformError} from "@interfaces/HydraCollection.ts";
...
export const ModalUpdateManageFiche = (
    ...
    const saveFiche = () => {
        fiche.configuration = fiche.configuration === "" ? null : fiche.configuration;
        mutate(fiche)
    };
                    ...
                    <div>
                        ...
                        >
                            ...
                            {fichesParent?.map((fiche: Fiche) => (
                                <option key={fiche.id} value={`/api/fiches/${fiche.id}`}>
                                    {fiche.idTerme}
                                </option>
                            ))}
                        </LabelSelectInput>
